...
$varAdminPass = $_POST['txtSubjectCode'];  
$_SESSION['ID_Fetch'] = $varstd_ID;
$varPassword =  $_SESSION['password'];

if($varAdminPass == $varPassword){
    $DeleteSTDdata = mysqli_query($dbc,"DELETE FROM `student_list` WHERE  IDnumber='$varstd_ID' "); 
//echo 'data1 -'.$DeleteSTDdata;
//echo 'data2 -'.$DeleteSTDdataSubject;
//die();
    if($DeleteSTDdata){
        $DeleteSTDdataSubject = mysqli_query($dbc,"DELETE FROM `std_subject` WHERE Student_ID='$varstd_ID' "); 
       header("location: Admin-StudentRecord.php?DataDelete=Success");
    }else{
     //   echo '<center><h1 style="color: red;" ><strong> There was a error !</strong> </h1></center>';
    }


}else{

  //  echo '<center><h1 style="color:  red; " ><strong> Incorrect Password !</strong> </h1></center>';
...
if($result){
    //  echo "INSERT Success";
     $QuerySubject = mysqli_query($dbc,"SELECT * From std_subject where  Student_ID ='$varstd_ID' ORDER BY `std_subject`.`YearLevel` ASC "); 
     header("location: Admin-StudentRecord-DataSelected-AUDGrades.php?AddSubject=Success"); 
     $QuerySubject = mysqli_query($dbc,"SELECT * From std_subject where  Student_ID ='$varstd_ID' ORDER BY `std_subject`.`YearLevel` ASC "); 
}
...
<head>
	...
	<title>Admin Student Record - Delete Information</title>
<!--
...
<a  class="form-control" style=" font-weight: bold;" href="Admin-StudentRecord-DataSelected-Update.php"><span> Update Information </span></a>

<?php 
    if($_SESSION['AdminLevel'] == "superuser"){
        echo '<a  class="form-control" style=" font-weight: bold;  background-color: seagreen;" href="Admin-StudentRecord-DataSelected-Delete.php"><span> Delete Information </span></a>';
    }else{

    }
 ?>
													
<a  class="form-control" style=" font-weight: bold; " href="Admin-StudentRecord-DataSelected-AUDGrades.php"><span>Add/Update Grades</span></a>													
...
<input type="text" id="SubjectCode" name="txtSubjectCode" maxlength="100" size="10" placeholder="SubjectCode" style="background: transparent;border-color: white;color: white;font-weight: 300;border-radius: 0;"  required>
  ...
  <input type="text" id="TeacherName" name="txtTeacherName" maxlength="100" size="12" placeholder="TeacherName" style="background: transparent;border-color: white;color: white;font-weight: 300;border-radius: 0;"  required>
        <br>
         <input type="text" id="Prelim" name="txtPrelim" maxlength="2" size="6" placeholder="Prelim" style="background: transparent;border-color: white;color: white;font-weight: 300;border-radius: 0;" >
...
<div class="tm-bg-transparent-black tm-contact-box-pad" >
    <center><h2 style="color:  #8bc34a; " >  <strong>Do you want to Delete This student Information [<?php echo $_SESSION['Student_ID_Autoload'] ?>] ? </strong> </h2></center>

 <center>
<form method="POST">    
<input hidden type="text"  id="std_ID2" name="std_ID2"> 
<input type="password" id="SubjectCode22" name="txtSubjectCode" maxlength="100" size="40" placeholder="Please re-enter your password to Delete" style="background: transparent;border-color: white;color: white;font-weight: 300;border-radius: 0; text-align: center;"  required> <br>
 <button type="submit" name="btnDeleteData"  style="width: 50%; color: cyan;   background: transparent;  ">Delete Student Data</button>
</form>   
<br>  
...
<?php  
                        ...
                        //Approve=Succes
                        if(strpos($FullUrl,"AddSubject=Success")){
