...
if (isset($_POST['btnRefresh'])) {
    ...
    $_SESSION['Student_ID_Autoload'] = $varstd_ID;
...
<br>
<br>
<a class="form-control" style=" font-weight: bold; background-color: seagreen;"  href="Admin-StudentRecord-DataSelected.php"><span>&#9776; Student Information </span></a>
...
<div class="tm-bg-transparent-black tm-contact-box-pad">
 ...
 <div >                                      
    ...
    <span hidden id="flieActualExt"></span><br> 
...
<script>
    ...
    document.getElementById("Attach").src = locationIMG +"?"+ new Date().getTime();
</script>
