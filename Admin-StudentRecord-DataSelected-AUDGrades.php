...
$deleteResult = mysqli_query($dbc,"DELETE FROM `std_subject` WHERE Student_ID ='".$_POST['std_ID2']."' AND SubjectCode ='".$_POST['txtSubjectCode']."'");

if($deleteResult){
    echo '<script>alert("Subject Delete");</script>';
}else{
     echo '<script>alert("Delete was not successfull");</script>';
}
...
<a  class="form-control" style=" font-weight: bold; background-color: seagreen; " href="Admin-StudentRecord-DataSelected-AUDGrades.php"><span>Add/Update Grades</span></a>													
...
<input type="text" id="SubjectCode22" name="txtSubjectCode" maxlength="100" size="15" placeholder="SubjectCode" style="background: transparent;border-color: white;color: white;font-weight: 300;border-radius: 0;"  required> <br>
 <button type="submit" name="btnFetchData"  style="width: 25%; color: cyan;   background: transparent;  ">Fetch Data</button>
 <button type="submit" name="btnDeleteData"  style="width: 25%; color: cyan;   background: transparent;  ">Delete Subject</button>
</form>   
<br>  
...
<?php  
                        ...
                        //Approve=Succes
                        if(strpos($FullUrl,"AddSubject=SuccessNA")){
